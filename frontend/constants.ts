        ...
        modules: [
          {
            ...
            configs: [
              ...
              },
              {
                id: "c2",
                name: "Logo",
                fileLocation: "/assets/images/logo.png",
                mappingType: "GLOBAL",
                mappingValue: "g2",
                regex: "-",
                description: "Logo Replace",
                isHidden: true,
                isSelected: true,
              },
            ],
...
export const MOCK_PERMISSIONS: Permission[] = [
...

  {
    ...
    description: "View deployment list",
    group: "Deployment",
  },
  {
    id: "p5",
    key: "deploy.build",
    name: "Trigger Build",
    description: "Trigger deployment builds",
    group: "Deployment",
  },
  {
    id: "p6",
    ...
    description: "Create/Edit deployments",
    group: "Deployment",
  },
